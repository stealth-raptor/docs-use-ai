...
import React from 'react'
    ...
    const CreateOptions = () => {
      ...
      return (
        <div >
            <div className='bg-card border border-muted shadow-md flex flex-col rounded-xl p-5 cursor-pointer justify-center items-center' onClick={()=> router.push('/dashboard/create-diagnosis')}>
